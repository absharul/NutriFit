...
class _ProgressScreenState extends State<ProgressScreen> {
  late Box<UserNutrition> nutritionBox; // Define the box
  ...
  void _onUserSelected(UserNutrition? user) {
    setState(() {
            ...
            child: Column(
              ...
              children: [
                ...
                if (selectedUser != null) ...[
                  ...
                  //display the meals for the particular user
                ],
...
//   late Box<AddMealBox> mealBox; // Define the box for meals
//   UserNutrition? selectedUser; // The currently selected user
...
//
//       if (user != null) {
//         // Fetch the meal box for the selected user
//         mealBox = Hive.box<AddMealBox>(user.id); // Use user ID to get their specific meal box
//
//         // Calculate the total kcal and protein
